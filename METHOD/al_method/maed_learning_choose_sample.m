...
[choose_part_serials,diff,diff_pos,rank,note]=maed_learning_choose_sample(m,now_part_train_sample_ind1,rest_part_train_sample_ind1,options_active);
%}

function [choose_part_serials,diff,diff_pos,rank,note]=maed_learning_choose_sample(m,now_part_train_sample_ind1,rest_part_train_sample_ind1,options_active)
%% 可1次搞定
%第一位是 选择的样本数量
%第二位是选择核函数0为高斯核
%第三位是核函数参数t
