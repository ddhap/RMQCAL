...
choose_num=3;
method=3;
 [new_rank,choose_serial]=aggregateranks_fusion(rank,choose_num,method);
%}
function [new_rank,choose_serial]=aggregateranks_fusion(rank,choose_num,method)
